 ...
 * @author CLAB_36
 */
public class Nested_Loop_1st extends javax.swing.JFrame {

    /**
     * Creates new form Nested_Loop_1st
     */
    public Nested_Loop_1st() {
        initComponents();
    }
...
for(x=1;x<=10;++x)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nested_Loop_1st.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nested_Loop_1st().setVisible(true);
            }
        });
    }
